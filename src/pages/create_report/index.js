    ...
    return (
        <div className="page-report px-10">
            ...
            <div className="d-flex justify-content-center mt-30">
               <a href="../search/index.js"> <button className="search-btn d-flex justify-content-center align-items-center"><img src={ArrowReturn} alt="" className="return-icon" />REVISE SEARCH</button> </a>
            </div>
        </div>
    )
}
